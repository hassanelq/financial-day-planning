...
export default function Home() {
  const programme = [
    ...
    },
    {
      ...
      details: [
        "<b>Bou Mhamed Abdelhamid<b/><br/>L'Ordre dans le Désordre : Le K-Means et la Quête de Structure dans la Finance de Marché",
        "<b>Daniel Anonwodji<b/><br/>Simulation Monte Carlo vs Optimisation quadratique : Minimisation du Tracking Error dans la gestion indicielle",
        "<b>Wassim Kerdoun<b/><br/>Monte Carlo Pricing of European Options with Volatility Surface and Greeks Analysis",
      ],
      images: [],
    },
